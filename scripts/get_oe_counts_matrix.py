...
kallisto_dir = '/home/jdubos2/mtstp/data/oe_kallisto_quantifications'
...
transposed_tpm_df.to_csv('/home/jdubos2/mtstp/data/counts_tables/oe_tpm_counts_kallisto.csv')

raw_df = pd.DataFrame(raw_counts_matrix)
transposed_raw_df = raw_df.transpose()
transposed_raw_df.to_csv('/home/jdubos2/mtstp/data/counts_tables/oe_raw_counts_kallisto.csv')
